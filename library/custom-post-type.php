...
function event_post_type() { 
	...
	register_post_type( 'event', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'edit_item' => __( 'Edit Eventss', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Events', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Events', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Events', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Past Events', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
